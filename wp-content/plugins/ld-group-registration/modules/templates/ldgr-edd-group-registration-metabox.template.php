		...
		<th style="text-align: left;">
			...
			echo esc_html(
				apply_filters(
					...
					__( 'Enable Group registration', 'wdm_ld_group' )
				)
			);
			?>
			 : </th>
			...
			<?php
				echo esc_html(
					apply_filters(
						...
						__( "Allow users to check 'Enable Group Registration' on the Front End", 'wdm_ld_group' )
					)
				);
				?>
			 : </th>
	...
	<tr class="wdm-default-front-option">
		<td colspan="2">
			<span style="font-weight: bold;">
				<?php esc_html_e( 'Default Option : ', 'wdm_ld_group' ); ?>
			</span>
			<input
				type="radio"
		...
		<th style="text-align: left;">
			...
			echo esc_html(
				apply_filters(
					...
					__( 'Ask Group Leader to pay for course', 'wdm_ld_group' )
				)
			);
			?>
			: </th>
