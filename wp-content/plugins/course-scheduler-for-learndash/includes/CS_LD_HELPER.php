...
class CS_LD_HELPER {
    ...
    public function ldccAdminMenu() {
        ...
        if (isset( $submenu[ 'wooninjas-dashboard' ] ) && in_array( 'wooninjas-dashboard-setting', wp_list_pluck( $submenu[ 'wooninjas-dashboard' ], 2 ) ) ) {
        ...
        if( ! $menuExist ) {
            if( class_exists( 'WN_DASHBOARD_Page' ) ) {
                ...
                add_menu_page( __( 'WooNinjas', 'cs_ld_addon' ), __( 'WooNinjas', 'cs_ld_addon' ), 'manage_options', 'wooninjas-dashboard', [ $obj_dashboard, 'dashboard_page' ], 'https://wordpress-475011-1491998.cloudwaysapps.com/wn_dashboard_icon.png' );
            ...
            if( class_exists( 'WN_DASHBOARD_SETTINGS' ) ) {
                ...
                add_submenu_page( 'wooninjas-dashboard', __( 'Settings', 'cs_ld_addon' ), __( 'Settings', 'cs_ld_addon' ), 'manage_options', 'wooninjas-dashboard-setting', [ $obj_settings, 'settings_page' ] );
            }
        } elseif( ! $setting_menuExist ) {
            if( class_exists( 'WN_DASHBOARD_SETTINGS' ) ) {
                $obj_settings = new WN_DASHBOARD_SETTINGS();
                add_submenu_page( 'wooninjas-dashboard', __( 'Settings', 'wn-plugin-boilerplate' ), __( 'Settings', 'wn-plugin-boilerplate' ), 'manage_options', 'wooninjas-dashboard-setting', [ $obj_settings, 'settings_page' ] );
            }
		}
