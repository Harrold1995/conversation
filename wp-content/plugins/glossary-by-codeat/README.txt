...
* Use it with your favorite plugins: Yoast SEO, Ninja Forms, Elementor, YARPP, Crayon Syntax Highlighter, role management plugins like User Role Editor, or multi-language plugins such as WPML and Polylang.
...
Take advantage of our **30 days money-back guarantee**!
...
Of course!
[Our extensive documentation covers](http://docs.codeat.co/glossary/getting-started/) all the features and tips to make the most of the Glossary plugin.
...
4. Glossary Widgets
5. Example of tooltip template
6. Example of tooltip template
