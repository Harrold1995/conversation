	...
	<div class="postbox">
		...
		<div class="inside">
			<ul>
				...
				<li><b>[glossary]</b> - <?php _e( 'This parse a specific content wrap with this shortcode, useful for Visual Composer or Page Builder.', GT_TEXTDOMAIN ); ?> [<a href='https://docs.codeat.co/glossary/shortcodes/#parse-content-premium' target='_blank'>Documentation</a>]</li>
