...
= 1.2.4 =
* Fix: LearnDash quiz pass and fail triggers
* Fix: Made addon compatible with latest WordPress, BadgeOS and LearnDash

= 1.2.3 =
* Fix: Removed temporary fix related to achievement/rank/points step title

= 1.2.2 =
* Fix: Conflict with LearnDash quiz

= 1.2.1 =
* Fix: Trigger count field updating issue
* Fix: Minor bugs

= 1.2 =
* New: Shifted the BadgeOS LearnDash settings to BadgeOS settings page
* New: Added a checkbox which will control the award points against a quiz. Point will be given on every quiz attempt or one time per quiz.
* New: Added show/hide feature which will show/hide fields when user enable/disable quiz points as badgeos points checkbox
* New: Option to award points/achievements/ranks on Passing Quiz with given % range
* New: Option to award points/achievements/ranks on Uploading an assignment
* New: Option to award points/achievements/ranks on Uploading an assignment to a Specific Lesson
* New: Option to award points/achievements/ranks on Uploading an assignment to a Specific Course
* New: Option to award points/achievements/ranks on Approval of Assignment
* New: Option to award points/achievements/ranks on Approval of Assignment to a Specific Lesson
* New: Option to award points/achievements/ranks on Approval of Assignment to a Specific Course
