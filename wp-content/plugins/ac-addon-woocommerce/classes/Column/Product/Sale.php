...
class Sale extends AC\Column
	implements ACP\Editing\Editable, ACP\Filtering\Filterable, ACP\Export\Exportable, ACP\Search\Searchable, ACP\Sorting\Sortable {
	...
	public function filtering() {
		return new Filtering\Product\Sale( $this );
	}
