<?php
	...
	$admin_bar_settings                    = isset( $plugin_settings['admin_bar'] ) ? $plugin_settings['admin_bar'] : '';
	$admin_bar_menu_settings               = isset( $admin_bar_settings['menu'] ) ? $admin_bar_settings['menu'] : '';
...
?>
	<style>
		...
		if ( isset( $admin_bar_menu_background_options['type'] ) ) {
		...
		if ( isset( $admin_bar_sub_menu_background_options['type'] ) ) {
		...
		if ( isset( $admin_bar_menu_settings ) ) {
		...
		if ( isset( $admin_bar_menu_settings['hover'] ) ) {
		...
		if ( isset( $admin_bar_settings['sub_menu'] ) ) {
		...
		if ( isset( $plugin_settings['admin_menu'] ) ) {
		...
		if ( isset( $admin_menu_settings['outer_background_settings']['sub_menu'] ) ) {
		...
		if ( isset( $admin_menu_settings['menu'])) {
		...
		if ( isset( $admin_menu_settings['sub_menu'] ) ) {
		...
		.eat-body-class-wrap.eat-dashboard-<?php echo $template; ?> #adminmenu a{ 
													  <?php
		...
		<?php if ( isset( $menu_hover_settings ) ) : ?>
		...
		?>
		.eat-body-class-wrap.eat-dashboard-<?php echo $template; ?> div.ir-admin-logo .ir-admin-menu-logo-title, .eat-body-class-wrap.eat-dashboard-<?php echo $template; ?> #wpadminbar div.ir-admin-logo .ir-admin-menu-logo-title { 
		<?php
			echo $title_font_dynamic_css;
		?>
			 }
		  .eat-body-class-wrap.eat-dashboard-<?php echo $template; ?> div.ir-admin-logo .ir-admin-menu-logo-subtitle, .eat-body-class-wrap.eat-dashboard-<?php echo $template; ?> #wpadminbar div.eat-admin-logo .ir-admin-menu-logo-subtitle { 
														<?php
