...
Tested with LearnDash version: 3.6.0
Tested with WooCommerce version: 5.7.1
...
== Changelog ==
= 4.0.1 =
* Fix: #75828 Fixed course reports pagination issue.
* Fix: Fixed commission report table styling issue.
* Fix: Fixed accent color setting for fresh installs.
* Tweak: #72356 Fixed styling of container on instructor dashboard.
= 4.0.0 =
* New: Introducing a brand new design for the instructor dashboard.
* New: Added new accent color settings for the instructor dashboard.
* Fix: #74495 Fixed instructor course reports.
* Fix: Fixed export csv for course and commission reports.
* Fix: #74975 Fixed submissions table sorting issues.
* Fix: #74858 Fixed critical error thrown on lesson edit.
* Tweak: Updated the course and earnings reports chart library.
* Removed: Admin customizer feature along with the template settings.
= 3.6.2 =
* Bug: #75510 Fixed fatal error with LearnDash 3.6.0 update.
* Update: Updated code to show in plugin update notices on plugins page.
= 3.6.1 =
* Bug: #74459 Fixed assignment approval bug causing course completion.
* Bug: Fixed duplicate instructor displayed for all instructor shortcode.
* Update : Added new action hooks when plugin is activated and deactivated.
* Tweak : Removed a filter hook expected to filter instructor capabilities and run on activation but it never executes.
* Tweak : Updated assignment restriction code
= 3.6.0 =
* Feature: Added new student teacher communication feature using buddypress private messages
* Update: Added new email filter hooks for course purchase email for instructors.
= 3.5.8 =
* Bug: #71229 Fixed lessons, topics and quizzes not fetched properly for shared courses.
* Bug: #71220 Fixed deprecated function check for getting total course steps in overview and reports.
= 3.5.7 =
* Update: Fixed instructor profile links on course grid pages.
* Bug: Fixed course update issues in classic editor.
* Update: Added multiple instructor shortcode styles for basic compatibility with themes.
= 3.5.6 =
* Update: Updated the instructor reports calculation based on user course steps rather than user progress meta.
* Tweak: Added hook 'ir_dashboard_addon_info' to filter dashboard tiles.
* Tweak: Loaded ir-review-script into footer to avoid dependency errors.
* Tweak: #69738 Added a hook 'ir_instructor_dashboard_logo_url' to add a link to Admin Menu Logo.
* Tweak: Added new filter hook 'ir_filter_instructor_profile_template' to allow easier overriding of profile template.
* Tweak: Updated instructor overview page layout.
* Bug: Fixed missing other extensions page issue.
* Bug: Fixed warning notices from the admin theme files.
* Bug: #69836 Fixed email tab display issue.
* Bug: #69837 Fixed course tab label issue.
* Bug: #69331 Course label not displaying on the instructor overview page.
* Bug: #69681 PHP error messages on instructor dashboard.
* Bug: #69848 Fixed all users visible under quiz statistics history and overview page.
* Bug: #70441 Fixed fatal error on question creation from builder with PHP v8.0.6.
= 3.5.5 =
* Feature: Added new `all_instructors` shortcode to display list of instructors on course or any other pages.
* Update: Updated Learndash stripe integration code to fix commission recording with latest updates.
* Update: Moved instructor commission settings code to new template file.
* Bug: Fixed translation ready strings.
* Bug: Fixed introduction settings list and paragraph data type swithcing issue.
* Bug: Fixed issue where site emails from name and email were set to instructor details for logged in instructor.
* Bug: Fixed course reports NAN issue for completed reports.
* Bug: Fixed instructor comments issue and other related.
* Bug: Fixed some filtering issues on lesson, topic and quiz listing pages.
= 3.5.4 =
